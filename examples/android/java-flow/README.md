# Shen.AI Android Java Flow

This native Android Java app embeds the Shen.AI SDK and shows two SDK-driven
...
```bash
./scripts/run_android_java_flow.sh -PshenaiApiKey=<your-api-key>
```
